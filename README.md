...
- Pkg folder: [packages\migration-events](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\migration-events)
...
graph LR
  ...
  migration_events["migration_events"]:::center
```
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package migration-events -Apply
