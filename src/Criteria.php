...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'system_name', 'from_version', 'to_version', 'status', 'started_at', 'finished_at', 'error', 'meta' ];
    }
    ...
    {
        $x = [ 'id', 'system_name', 'from_version', 'to_version', 'status', 'started_at', 'finished_at', 'error' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\MigrationEvents\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\MigrationEvents\Definitions::softDeleteColumn();
