...
final class MigrationEventsModule implements ModuleInterface
{
    public function name(): string { return 'table-migration_events'; }
    public function table(): string { return 'migration_events'; }
    ...
    public static function contractView(): string { return 'vw_migration_events'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_mig_started', 'idx_mig_system_status' ];
        if ($d->isMysql()) {
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_mig_started', 'idx_mig_system_status' ],
            'foreignKeys' => [],
        ];
    }
}
