...
namespace BlackCat\Database\Packages\MigrationEvents\Mapper;

use BlackCat\Database\Packages\MigrationEvents\Dto\MigrationEventDto;
use BlackCat\Database\Packages\MigrationEvents\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO MigrationEventDto:
 ...
 */
final class MigrationEventDtoMapper
{
    /** @var array<string,string> Column -> DTO property */
    private const COL_TO_PROP = [ 'id' => 'id', 'system_name' => 'systemName', 'from_version' => 'fromVersion', 'to_version' => 'toVersion', 'status' => 'status', 'started_at' => 'startedAt', 'finished_at' => 'finishedAt', 'error' => 'error', 'meta' => 'meta' ];
    ...
    /** @var string[] */
    private const DATE_COLS   = [ 'started_at', 'finished_at' ];
    /** @var string[] */
     ...
     */
    public static function fromRow(array $row): MigrationEventDto
    {
        /** @var MigrationEventDto */
        return DtoHydrator::fromRow(
            MigrationEventDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?MigrationEventDto
    {
     ...
     *
     * @param MigrationEventDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(MigrationEventDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(MigrationEventDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(MigrationEventDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,MigrationEventDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,MigrationEventDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(MigrationEventDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,MigrationEventDto>
     */
