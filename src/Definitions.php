...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'migration_events'; }
    public static function contractView(): string { return 'vw_migration_events'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'system_name', 'from_version', 'to_version', 'status', 'started_at', 'finished_at', 'error', 'meta' ]; }
