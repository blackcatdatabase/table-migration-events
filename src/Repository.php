...
use BlackCat\Database\Packages\MigrationEvents\Repository\MigrationEventRepository;
...
{
    private MigrationEventRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new MigrationEventRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\MigrationEvents\Dto\MigrationEventDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\MigrationEvents\Dto\MigrationEventDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\MigrationEvents\Dto\MigrationEventDto|null
    {
