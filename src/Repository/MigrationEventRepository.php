...
namespace BlackCat\Database\Packages\MigrationEvents\Repository;
...
use BlackCat\Database\Packages\MigrationEvents\Criteria;
use BlackCat\Database\Packages\MigrationEvents\Dto\MigrationEventDto as Dto;
use BlackCat\Database\Packages\MigrationEvents\Mapper\MigrationEventDtoMapper as RowMapper;
...
final class MigrationEventRepository implements RepoContract, KeysetRepoContract
{
     ...
     */
    protected function def(): string { return \BlackCat\Database\Packages\MigrationEvents\Definitions::class; }
    ...
    public function upsertMany(array $rows): int {
        ...
        if (class_exists(\BlackCat\Database\BulkUpsertRepository::class) && [] !== []) {
            $bulk = new \BlackCat\Database\BulkUpsertRepository($this->db, \BlackCat\Database\Packages\MigrationEvents\Definitions::table());
    ...
    */
    ...
    /** @return array<string,mixed>|\BlackCat\Database\Packages\MigrationEvents\Dto\MigrationEventDto|null */
    public function getById(int $id, bool $asDto = false): array|\BlackCat\Database\Packages\MigrationEvents\Dto\MigrationEventDto|null {
        $row = $this->getByUnique([ 'id' => $id ]);
        if (!$asDto || !$row) return $row;
        return \BlackCat\Database\Packages\MigrationEvents\Mapper\MigrationEventDtoMapper::fromRow($row);
    }
